...
def main():
    ...
    tokenizer = AutoTokenizer.from_pretrained(
        model_args.tokenizer_name if model_args.tokenizer_name else model_args.tokenizer_model_name_or_path,
        cache_dir=model_args.cache_dir,
    ...
    model = DoubleT5ForConditionalGeneration.from_pretrained(
    ...
    model.triplet_model = T5ForConditionalGeneration.from_pretrained(model_args.triplet_model_name_or_path)
    ...
    def preprocess_function(examples):
        ...
        for i in range(len(examples[text_column])):
            if examples[text_column][i] is not None and examples[summary_column][i] is not None and examples[text_for_generation_column][i] is not None:
