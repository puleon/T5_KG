...
def main():
    ...
    def model_init(model_args, data_args, config, tokenizer):
        config.vocab_size = 32128
        config.dropout_rate = data_args.dropout_rate
    ...
    model = model_init(model_args, data_args, config, tokenizer)
    # Data collator
    ...
    trainer = Seq2SeqTrainer(
        model_init=partial(model_init, model_args, data_args, config, tokenizer),
        args=training_args,
    ...
    if training_args.do_train:        
        ...
        kwargs = {
            # "resources_per_trial": {"cpu": 6, "gpu": 3},
