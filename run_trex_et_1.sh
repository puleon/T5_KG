...
model_dir=./trained_models/t5_${task}_1_padtomaxlenF_bmf1_adaf_bs64
dt=$(date '+%d.%m.%Y_%H.%M.%S')
mkdir $model_dir
cp ./run_trex_et_1.sh $model_dir/run_trex_et_1.sh_$dt
cp ./run_summarization_finetune_1.py $model_dir/run_summarization_finetune_1.py_$dt

python ./run_summarization_finetune_1.py \
