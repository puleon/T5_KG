...
task=openentity
model_dir=/home/pugachev/github/T5_KG/trained_models_hs/${task}_base_HS_hyperopt_lr_warmupratio_numtrep_dropout0.3
dt=$(date '+%d.%m.%Y_%H.%M.%S')
mkdir $model_dir
cp ./run_openentity_HS.sh $model_dir/run_openentity_HS.sh_$dt
