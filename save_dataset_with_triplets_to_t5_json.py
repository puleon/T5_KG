...
from utils_glue import processors, preprocessor_functions, preprocessor_functions_with_triplets
...
def load_and_save_examples(args, dataset_type):
    ...
    if args.use_triplets:
        t5_examples = preprocessor_functions_with_triplets[args.task_name](examples, triplets, relations)
    else:
        t5_examples = preprocessor_functions[args.task_name](examples, relations)
